...
@section('page_title', ' TimeTable Records')
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                ...
                <li class="nav-item"><a href="#add-sub" class="nav-link" data-toggle="tab">Add Activity</a></li>
                <li class="nav-item"><a href="#edit-subs" class="nav-link " data-toggle="tab">Edit Activity</a></li>
