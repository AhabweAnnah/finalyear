...
@section('page_title', 'Industrial Training Platform')
@section('content')
               ...
               <div class="card card-body bg-danger-400 has-bg-image">
                   <div class="media">
                       <div class="media-body">
                           ...
                           <span class="text-uppercase font-size-xs">Total Supervisors</span>
                       </div>
               ...
               <div class="card card-body bg-success-400 has-bg-image">
                   <div class="media">
                       ...
                       <div class="media-body text-right">
                           ...
                           <span class="text-uppercase font-size-xs">Total Coordinators</span>
                       </div>
                   </div>
               </div>
           </div>
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">University Events </h5>
         {!! Qs::getPanelOptions() !!}
        </div>
