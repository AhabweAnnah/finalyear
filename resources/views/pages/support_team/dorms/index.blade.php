...
@section('content')
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Manage Supervisors</h6>
            {!! Qs::getPanelOptions() !!}
        </div>

        <div class="card-body">
           <!-- <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#all-dorms" class="nav-link active" data-toggle="tab">Manage Supervisors</a></li>
                <li class="nav-item"><a href="#new-dorm" class="nav-link" data-toggle="tab"><i class="icon-plus2"></i> Create Supervisors</a></li>
            </ul> -->
