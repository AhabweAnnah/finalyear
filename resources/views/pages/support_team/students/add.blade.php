               ...
               @csrf
                ...
                <fieldset>
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ old('address') }}" class="form-control" placeholder="Course" name="address" type="text" required>
                            </div>
                        </div>
                    ...
                    <div class="row">
                       ...
                       <!-- <div class="col-md-3">
                            <div class="form-group">
                                <label for="nal_id">Course: <span class="text-danger">*</span></label>
