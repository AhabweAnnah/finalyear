        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6 border-right-2 border-right-blue-400">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label font-weight-semibold">This Training starts</label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            <label for="lock_exam" class="col-lg-3 col-form-label font-weight-semibold">Lock Submission</label>
                            <div class="col-lg-3">
