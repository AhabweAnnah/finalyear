                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <div class="text-center mb-3">
                                ...
                                <span class="d-block text-muted">Provide your credentials</span>
                            </div>
                            ...
                            <div class="form-group ">
                                <input type="text" class="form-control" name="identity" value="{{ old('identity') }}" placeholder="User Name or Email">
                            </div>
